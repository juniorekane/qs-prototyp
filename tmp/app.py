...
def ablesung_hinzufuegen():
    ...
    if request.method == "POST":
        ...
        try:
            ...
            wert = int(request.form["wert"])  # Explizite Konvertierung
            ableser = request.form.get("ableser", "Unbekannt")  # Standardwert setzen
        ...
        if vorherige_ablesungen:
            ...
            if wert < letzter_wert:
                return jsonify({"error": "Neuer Ablesewert muss größer sein als der vorherige"}), 400
        ...
        return jsonify({"message": "Ablesung erfolgreich gespeichert"}), 201
